...
// mesma. Num projeto que você está trabalhando, você foi designado a refatorar diversas funções para que façam
...
function removerPropriedade(objeto, propriedade){
    const obejto_novo = Object.assign({}, objeto)
    delete obejto_novo[propriedade]
    return obejto_novo
}
